...
namespace Squareetlabs\LaravelTeamsPermissions\Middleware;
...
use Squareetlabs\LaravelTeamsPermissions\Support\Facades\Teams as TeamFacade;
...
class Teams
{
    ...
    protected function authorization(Request $request, string $method, string|array $params, ?string $teamId, ?array $models, bool $require = false): bool
    {
        ...
        $foreignKey = Config::get('teams.foreign_keys.team_id');
