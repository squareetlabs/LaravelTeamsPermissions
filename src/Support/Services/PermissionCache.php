 ...
 * 
 * Handles caching of team permissions and related data.
...
{
    /**
     * Remember a value in cache with team permissions tags.
     * 
    ...
    public function remember(string $key, callable $callback, ?int $ttl = null): mixed
    {
        ...
        $prefix = Config::get('teams.cache.prefix');
        $fullKey = $prefix . ':' . $key;
        $ttl = $ttl ?? Config::get('teams.cache.ttl');

        if (Config::get('teams.cache.tags')) {
            return Cache::tags(['teams', 'permissions'])
    ...
    /**
     * Flush all team permissions cache.
     * 
     * Removes all cached values tagged with 'teams' and 'permissions'.
    ...
    public function flush(): void
    {
        ...
        Cache::tags(['teams', 'permissions'])->flush();
    }
    ...
    public function forget(string $key): void
    {
        ...
        Cache::tags(['teams', 'permissions'])->forget($fullKey);
    }
    ...
    public function get(string $key, mixed $default = null): mixed
    {
        ...
        return Cache::tags(['teams', 'permissions'])->get($fullKey, $default);
    }
}
