...
class MakePolicyCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'teams:policy {name} {--model=}';
     ...
     * @var string
     */
    protected $description = 'Create a new team policy class';
...
class {{ class }} extends TeamPolicy
{
    /**
    ...
    {
        $team = $this->getTeamFromModel(${{ modelVariable }});
        
        if (!$team) {
            return false;
        }

        return $this->checkTeamPermission($user, $team, '{{ modelVariable }}.view');
    }

    /**
     * Determine if the user can create models.
     */
    public function create(Model $user, Model $team = null): bool
    {
        if (!$team) {
            return false;
        }

        return $this->checkTeamPermission($user, $team, '{{ modelVariable }}.create');
    }
    ...
    public function update(Model $user, {{ model }} ${{ modelVariable }}): bool
    {
        ...
        return $this->checkTeamAbility($user, $team, '{{ modelVariable }}.update', ${{ modelVariable }});
    }
    ...
    public function delete(Model $user, {{ model }} ${{ modelVariable }}): bool
    {
        ...
        return $this->checkTeamAbility($user, $team, '{{ modelVariable }}.delete', ${{ modelVariable }});
    }
